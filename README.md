...
- [] Implement a backup strategy for all apps using Google Drive and test a full recovery scenario
...
- [] Check if Wholphin is a good replacement TV app for Jellyfin & Jellyseerr
