...
CREATE INDEX `oauthAccessToken_token_idx` ON `oauth_access_token` (`token`);--> statement-breakpoint
...
CREATE INDEX `oauthClient_clientId_idx` ON `oauth_client` (`client_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `oauthRefreshToken_token_idx` ON `oauth_refresh_token` (`token`);