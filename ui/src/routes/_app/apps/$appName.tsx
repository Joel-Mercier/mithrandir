...
function AppDetailPage() {
	...
	const app = mockAppDetails[appName];
	...
	return (
		<div className="mx-auto max-w-7xl px-4 py-8">
			...
			<div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
				...
				<div className="flex flex-wrap items-center gap-2">
					...
					<Button
						...
						onClick={() =>
							toast.error(`${app.displayName} would be uninstalled.`)
						}
					>
			...
			<p className="mb-6 text-sm text-muted-foreground">{app.description}</p>
					...
					<Card>
						...
						<CardContent className="space-y-4">
							<div className="space-y-1.5">
								...
								<Progress
									value={app.cpuUsage}
									className={progressColor(app.cpuUsage)}
								/>
							</div>
							<div className="space-y-1.5">
								<div className="flex items-baseline justify-between text-sm">
								...
								<Progress
									value={Math.min(
										Math.round((app.ramUsageMB / 1024) * 100),
										100,
									)}
