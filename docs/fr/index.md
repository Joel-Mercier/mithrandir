...
features:
  ...
  - icon: "🔒"
    title: HTTPS prêt à l'emploi
    details: HTTPS wildcard via le reverse proxy Caddy avec des certificats Let's Encrypt automatiques via DuckDNS.
  - icon: "📊"
    title: Surveillance de la santé
    details: Vérifications de santé intégrées pour Docker, l'espace disque, la fraîcheur des sauvegardes et l'état des conteneurs.
---
